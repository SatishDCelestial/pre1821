...
public:
    ...
    _RTLENTRY string( const char _FAR *cp, size_t orig, size_t n = NPOS ); // throw( xalloc, lengtherror );
	...
	VS_STD::istream _FAR & _RTLENTRY read_file( VS_STD::istream _FAR &is );
    VS_STD::istream _FAR & _RTLENTRY read_string( VS_STD::istream _FAR &is );
    VS_STD::istream _FAR & _RTLENTRY read_line( VS_STD::istream _FAR &is );
    VS_STD::istream _FAR & _RTLENTRY read_to_delim( VS_STD::istream _FAR &is, char delim = '\n' );
    VS_STD::istream _FAR & _RTLENTRY read_token( VS_STD::istream _FAR &is );
...
VS_STD::istream _FAR &
_RTLENTRY _FARFUNC operator >> ( VS_STD::istream _FAR &is, OWL::string _FAR &s );

VS_STD::ostream _FAR &
_RTLENTRY _FARFUNC operator << ( VS_STD::ostream _FAR &os, const OWL::string _FAR &s );

VS_STD::istream _FAR &
_RTLENTRY _FARFUNC getline( VS_STD::istream _FAR &is, OWL::string _FAR &s );

VS_STD::istream _FAR &
_RTLENTRY _FARFUNC getline( VS_STD::istream _FAR &is, OWL::string _FAR &s, char c );

OWL::string _RTLENTRY _FARFUNC to_lower( const OWL::string _FAR &s ) throw();
OWL::string _RTLENTRY _FARFUNC to_upper( const OWL::string _FAR &s ) throw();
OWL::string _RTLENTRY _FARFUNC operator + ( const char _FAR *cp,
                                    const OWL::string _FAR & s)
                                    throw( OWL::xalloc, OWL::string::lengtherror );
OWL::string _RTLENTRY _FARFUNC operator + ( const OWL::string _FAR &s1,
                                    const OWL::string _FAR &s2 )
                                    THROW_XALLOC_LENGTHERROR;
...
class _EXPCLASS TStringRef : public TReference
{
    ...
    _RTLENTRY TStringRef(unsigned char c, size_t n) : TStringRef((char)c, n) {}
	_RTLENTRY TStringRef(signed char c, size_t n) : TStringRef((char)c, n) {}
    ...
    void _RTLENTRY read_to_delim( VS_STD::istream _FAR &is, char delim ) throw( xalloc );
    void _RTLENTRY read_token( VS_STD::istream _FAR &is ) throw( xalloc );
...
inline int _RTLENTRY TSubString::operator == ( const string _FAR &_s ) const THROW_NONE
{
    return operator==(_s.c_str());
}
